...
import NewYearDemo from "./pages/NewYearDemo";
import SnowDemo from "./pages/SnowDemo";
    ...
    <WeatherProvider>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/demo/newyear" element={<NewYearDemo />} />
          <Route path="/demo/snow" element={<SnowDemo />} />
